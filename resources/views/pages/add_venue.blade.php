...
<div class="page-container">
    <form action="{{url('/venue')}}" method="post" class="form form-horizontal" id="form-venue-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="phone" id="venue_phone" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Airbnb：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="airbnb" id="venue_airbnb" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">Weblink：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="weblink" id="venue_weblink" placeholder="" value="" class="input-text" style="width:90%">
            </div>
        </div>
